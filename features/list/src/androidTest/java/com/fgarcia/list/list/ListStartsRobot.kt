...
import com.fgarcia.list.R
import com.fgarcia.list.extension.asJsonString
import com.fgarcia.list.presentation.list.adapter.viewholder.ItemStarsViewHolder
...
class ListStartsRobot {
    ...
    fun checkShowError() {
        Espresso.onView(
            ViewMatchers.withId(com.fgarcia.common.R.id.text_initial_loading_error)
        ).check(
            ViewAssertions.matches(isDisplayed())
        )
    }
